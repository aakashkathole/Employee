      ...
      >
        <View style={styles.tableContainer}>
          ...
          <View style={[styles.tableRow, styles.tableHeader]}>
            ...
            <Text style={[styles.headerText, { width: 150 }]}>Memo Name</Text>
          ...
          {memo.length > 0 ? (
            memo.map((item, index) => (
              <View key={item.id || index} style={styles.tableRow}>
                ...
                <Text style={[styles.tableCell, { width: 150 }]}>{item.memoName || 'N/A'}</Text>
...
const styles = StyleSheet.create({
  ...
  emptyText: { padding: 20, fontFamily: 'Poppins-Regular', textAlign: 'center', color: '#999' }
});